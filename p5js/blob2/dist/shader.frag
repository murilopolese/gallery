...
void main(void) {
  ...
  for (int i = 0; i < 20; i++) {
    ...
    vec2 p1 = vec2(
      0.5 + 0.35 * sin(2.0*sin(u_time*0.1) + j*3.0),
      0.5 + 0.35 * cos(2.0*sin(u_time*0.2) + j*3.0)
    );
  ...
  for (int i = 0; i < 20; i++) {
    float j = float(i) * u_time * 0.02;
    vec2 p1 = vec2(
      0.5 + 0.35 * sin(2.0*sin(u_time*0.5) + j*3.0),
      0.5 + 0.35 * cos(2.0*sin(u_time*0.4) + j*3.0)
    );
    float d1 = distance(p, p1);
    float c1 = 0.002 / d1;
    c += c1;
  ...
  for (int i = 0; i < 20; i++) {
    float j = float(i) * u_time * 0.02;
    vec2 p1 = vec2(
      0.5 + 0.35 * sin(2.0*sin(u_time*0.4) + j*3.0),
      0.5 + 0.35 * cos(2.0*sin(u_time*0.3) + j*3.0)
    );
    float d1 = distance(p, p1);
    float c1 = 0.002 / d1;
    c += c1;
